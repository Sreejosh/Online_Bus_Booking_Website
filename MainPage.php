  ...
  .offer {
    ...
    <body>
        <div class="navbar">
          ...
          <a href="SignInPage.php">L<img src="https://i.pinimg.com/originals/d3/7b/02/d37b020e87945ad7f245e48df752ed03.jpg" alt="Profile">gin</a>
        ...
        //   echo '<script>';
        //   echo 'window.open("SignInPage.php", "_blank", "width=600,height=800,top=200,left=200");';
        //   echo '</script>';
        // }
// ?>
        <div class="search">
           ...
           <form class="form-inline" method="post">
            ...
            <input type="submit" id="#search" name="search" value="SEARCH" onclick="return message();">
           </form>
        </div>
        ...
        <div class="offers" id="offers">
            ...
            <div class="offer">
                ...
                <div class="middle">
                  <div class="text"><button class="button" onclick="return message();">Claim Offer</button></div>
                </div>
              </div>
            <div class="offer">
            ...
            <div class="offer">
              ...
              <div class="offer">
                <img src="https://images.railyatri.in/ry_images_prod/SafetyBanner-1604043106.jpg" alt="Bus-offer-3" style="width : 100%">
                  <div class="middle">
                    <div class="text"><a href=""><button class="button" onclick="return message();">Claim Offer</button></a></div>
                  </div>
                </div>
            </div>
        </div>
             ...
             <p>OnlineBus has simplified the online bus booking process for your travel planning. You can save time and money by using CharanCash. Book now!!!
              ...
              <p>In this day and age of technology, offline modes of bus ticket booking are no more a preference. Online ticket booking is easy, fast and hassle-free. OnlineBus ticks off all three with our easy app and website navigation.
                ...
                <ul>
                  ...
                  <li>Free cancellation feature. </li>
                  <li>Access to payment partner discounts and cashback offers.
