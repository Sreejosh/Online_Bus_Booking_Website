    ...
    <body>
        ...
        <p style="font-size: 3rem; color:#FFFFFF"> Book Your Bus Tickets</p>
           ...
           <form class="form-inline" method="post" action="Mainprofile.php">
            ...
            <input type="text" id="#bustype" name="bustype" list="bustype" placeholder="BUS TYPE">
            <datalist id="bustype">
            <option value="AC Sleeper">
              <option value="Non AC Sleeper">
              <option value="Non AC Semi Sleeper">
              <option value="AC Semi Sleeper">
              <option value="Deluxe">
              <option value="Super Luxury">
</datalist> 
...
$sql = "SELECT * FROM bustable WHERE source='$source' AND destination = '$destination' AND bustype='$bustype'";
...
<td>".$row['price']."</td>
<td class='book' name='book'><a href='buspayment.php'>BOOK</a></td>
</tr>";
}
echo "</table>";
} else {
...
<div class="offers" id="offers">
            ...
            <div class="offer">
                ...
                <div class="middle">
                  <div class="text"><a href="offer1.php"><button class="button">Claim Offer</button></a></div>
                </div>
              </div>
            <div class="offer">
              <img src="https://cdn.grabon.in/gograbon/images/web-images/uploads/1591861321093/bus-coupons.jpg" alt="Bus-offer-2" style="width : 100%">
                <div class="middle">
                  <div class="text"><a href="offer2.php"><button class="button">Claim Offer</button></a></div>
                </div>
              </div>
            <div class="offer">
              <img src="https://images.railyatri.in/ry_images_prod/SafetyBanner-1604043106.jpg" alt="Bus-offer-3" style="width : 100%">
                <div class="middle">
                  <div class="text"><a href="offer3.php"><button class="button">Claim Offer</button></a></div>
                </div>
              </div>
              <div class="offer">
                <img src="https://images.railyatri.in/ry_images_prod/SafetyBanner-1604043106.jpg" alt="Bus-offer-3" style="width : 100%">
...
$ft = fopen("bustype.txt","w+");
if (isset($_POST['search'])){
  fwrite($fs,$_POST['source']);
  fwrite($fd,$_POST['destination']);
  fwrite($ft,$_POST['bustype']);
}
fclose($fs,$fd,$ft);
?>